...
class StockHistory(models.Model):
    ...
    open_price = models.DecimalField(max_digits=15, decimal_places=4, null=True)
    high_price = models.DecimalField(max_digits=15, decimal_places=4, null=True)
    low_price = models.DecimalField(max_digits=15, decimal_places=4, null=True)
    close_price = models.DecimalField(max_digits=15, decimal_places=4, null=True)
